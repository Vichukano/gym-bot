...
@Slf4j
@AllArgsConstructor
public class SelectWeightHandler implements BotMessageHandler<Update, SendMessage> {
    ...
    public SendMessage handle(Update update) {
        ...
        log.info("Selected weight: {}", weight);
        //TODO: Нужно взять айди юзера и сохранить вес в крайнее упражнение
        out.setText("Вы ввели вес" + weight + "выберите количество повторений для упражнения");
        return out;
    }
}
